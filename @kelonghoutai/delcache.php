        ...
        <div class="right_main">
            ...
            <table width="98%" border="0" cellpadding="4" cellspacing="1" class="tableoutline">
                ...
                <tr align=center class="firstalt">
                    ...
                    <td style="color: #FF0000;"><?php echo @round(@filesize(VV_CACHE . "/index.html") / 1024, 2) ?>KB
                    </td>
                    <td style="text-align:center"><input type="button" class="bginput"
                                                         style="height:19px; font-size:12px" value="清除"
                                                         onClick="javascript:location.href='?id=del&del=index';"
                                                         name="Input"></td>
                </tr>
                <tr align=center class="firstalt">
                    <td>内页缓存</td>
                    <td>../data/cache/html</td>
                    <td style="color: #FF0000;" id="getdirsize"><a href="javascript:" onclick='getdirsize();'>点击获取</a>
                    </td>
                    <td style="text-align:center"><input type="button" class="bginput"
                                                         style="height:19px; font-size:12px" value="清除"
                                                         onClick="javascript:location.href='?id=del&del=other';"
                                                         name="Input"></td>
                </tr>
                <tr align=center class="firstalt">
                    <td>图片缓存</td>
                    <td>../data/cache/img</td>
                    <td style="color: #FF0000;" id="getimgsize"><a href="javascript:" onclick='getimgsize();'>点击获取</a>
                    </td>
                    <td style="text-align:center"><input type="button" class="bginput"
                                                         style="height:19px; font-size:12px" value="清除"
                                                         onClick="javascript:location.href='?id=del&del=img';"
                                                         name="Input"></td>
                </tr>
                <tr align=center class="firstalt">
                    <td>css缓存</td>
                    <td>../data/cache/css</td>
                    <td style="color: #FF0000;" id="getcsssize"><a href="javascript:" onclick='getcsssize();'>点击获取</a>
                    </td>
                    <td style="text-align:center"><input type="button" class="bginput"
                                                         style="height:19px; font-size:12px" value="清除"
                                                         onClick="javascript:location.href='?id=del&del=css';"
                                                         name="Input"></td>
                </tr>
                <tr align=center class="firstalt">
                    <td>js缓存</td>
                    <td>../data/cache/js</td>
                    <td style="color: #FF0000;" id="getjssize"><a href="javascript:" onclick='getjssize();'>点击获取</a>
                    </td>
                    <td style="text-align:center"><input type="button" class="bginput"
                                                         style="height:19px; font-size:12px" value="清除"
                                                         onClick="javascript:location.href='?id=del&del=js';"
                                                         name="Input"></td>
                </tr>
                <tr align=center class="firstalt">
                    <td>URL重定向缓存</td>
                    <td>../data/cache/redirect_url</td>
                    <td style="color: #FF0000;" id="getredirectsize"><a href="javascript:" onclick='getredirectsize();'>点击获取</a>
                    </td>
                    <td style="text-align:center"><input type="button" class="bginput"
                                                         style="height:19px; font-size:12px" value="清除"
                                                         onClick="javascript:location.href='?id=del&del=redirect';"
                                                         name="Input"></td>
                </tr>
                <tr align=center class="firstalt">
                    <td>蜘蛛爬行记录</td>
                    <td>../data/zhizhu.txt</td>
                    <td style="color: #FF0000;"><?php echo @round(@filesize(VV_DATA . "/zhizhu.txt") / 1024, 2) ?>KB
                    </td>
                    <td style="text-align:center"><input type="button" class="bginput"
                                                         style="height:19px; font-size:12px" value="清除"
                                                         onClick="javascript:location.href='?id=del&del=zhizhu';"
                                                         name="Input"></td>
                </tr>
                <tr align=center class="firstalt">
                    <td>一键清除全部缓存</td>
                    ...
                    <td style="text-align:center"><input type="button" class="bginput"
                                                         style="height:19px; font-size:12px" value="清除"
                                                         onClick="javascript:location.href='?id=del&del=all';"
                                                         name="Input"></td>
                </tr>
                </tbody>
            </table>
